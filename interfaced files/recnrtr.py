...
ocr = PaddleOCR(det_model_dir=None, rec_model_dir=r"/PaddleOCR/inference/rec_mtb_nrtr", use_angle_cls=True, use_gpu=False, gpu_id=0, rec_char_type='en',rec_image_shape="1,32,100")
